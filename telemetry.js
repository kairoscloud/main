...
// format: browser-version-platform-123456
...
// update the telemetry entry every 2 minutes
...
function formatLogStack() {
  ...
  //   }
  // }
  return window.logStack.join("\n");
}

function getUsername() {
  let userNameContainer = document.querySelector(
