...
function shortenLink() {
  ...
  const options = {
    ...
    body: JSON.stringify({
      ...
      cloaking: document.getElementById("maskURL").checked,
      domain: "jostens.co",
    }),
  };
