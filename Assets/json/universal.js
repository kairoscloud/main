(async () => {
  ...
  status = "active";
  is_lite_plan = false; /*! jQuery v3.5.1 | (c) JS Foundation and other contributors | jquery.org/license */
  !(function (e, t) {
    "use strict";
  ...
  var customizer_script = document.createElement("script");
  customizer_script.type = "text/javascript";
  customizer_script.src =
    "https://cdn.everypages.com/ghl-customizer/ghl_customize.php?agency_id=1x762kiz4" +
    "&r=" +
    detectVueVersion();
  customizer_script.id = "ghl_customizer";
  document.body.appendChild(customizer_script);

  customizer_config = cfData;
  preview_cfg = cfData;
  localStorage.setItem("shouldFetchAddress", true);
  localStorage.setItem("disabledCompanies", "[]");
  localStorage.setItem(
    "customizer_script_root",
    "https://cdn.everypages.com/ghl-customizer",
  );
  localStorage.setItem("shouldUpdateLicenseData", false);
})();
